...
import { HelpingHand, Settings,NotebookTabs,LogOut } from 'lucide-react';
...
const Menu2 = () => {
    ...
    const handleItemClick = (text) => {
        ...
        return (
            <>
                <nav className="h-screen bg-gray-200 flex flex-row px-10 w-[10%] md:w-auto px-2 md:px-6 py-6 mt-10 ">
